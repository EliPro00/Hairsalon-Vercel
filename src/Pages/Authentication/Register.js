                                ...
                                <Row>
                                    <Col md={12}>
                                        ...
                                        <Label className="form-label">Email</Label>
                                            ...
                                            type="email"
                                            onChange={(e) => {
                                                setEmail(e.target.value); // Your custom handler logic
                                                console.log(e.target.value)
                                                validation.handleChange(e); // Delegating to Formik's handleChange
                                              }}
                                        ...
                                        <div className="d-grid mt-4">
                                            <button disabled={isloading} className={error ? "btn btn-secondary waves-effect waves-light" : "btn btn-primary waves-effect waves-light"} type="submit">Register</button>
                                        </div>
                                        <br>
                                        </br>
                                        <div className="form-check">
                                            <label className="form-check-label fw-normal" htmlFor="term-conditionCheck">{error && <p>{error}</p>}</label>
                                        </div>
                                    </Col>
                                </Row>
                            </Form>
