...
import AddBarberForm from "../CustomPages/BP_reg/Barber_reg.jsx";
...
import BarbershopReg from "../CustomPages/BP_reg/BarbershopReg.jsx";
import BarberTable from "../CustomPages/BP_reg/barberTables.jsx";
import CreateAppointmentForm from "../CustomPages/BP_reg/createAppoint.jsx";
import Practice from "../CustomPages/BP_reg/practice.jsx";
import NewAppoint from "../CustomPages/BP_reg/newAppoint.jsx";
import BarberDetail from "../CustomPages/BP_reg/barberDetail.jsx";


const authProtectedRoutes = [
  //dashboard
  { path: "/dashboard", component: <Dashboard /> },
  { path: "/bp-register", component: <BarbershopReg /> },
  { path: "/add-barber", component : <AddBarberForm />},
  { path: "/newappoint", component : <NewAppoint />},
  { path: "/barberdetail", component : <BarberDetail />},
  ...
  { path : '/barbertables' , component : <BarberTable />},
  { path: "/table-datatables", component: <DataTable /> },
  { path: "/createappoint", component: <CreateAppointmentForm /> },
